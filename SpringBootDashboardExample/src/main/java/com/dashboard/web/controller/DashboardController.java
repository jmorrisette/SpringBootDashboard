...
import com.dashboard.web.service.StatService;
...
public class DashboardController {
	...
	public String showServerStats(ModelMap model) {
		String name = getLoggedInUserName(model);
		model.put("stats", service.retrieveServerStats());
		return "list-ServerStats";
	}
